...
// Class Definition for Lemmatization
public class Lemmatization { 
	...
	public static final int LY  = 7;
	public static final int IES = 8;
	public static final int IED = 9;
	public static final int IER = 10;
	public static final int VED = 11;
	public static final int US  = 12;
	public static final int OES = 13;
	public static final int VES = 14;
	public static final int IEST = 15;
	
	// Constructor
	public Lemmatization() {}
	
	//
	public static String lemma( String stemmed, int ending ) {
		if ( false == flag )
			return stemmed;
		
		switch ( stemmed.charAt( 0 ) ) {
		case 'a': switch ( stemmed.charAt( 1 ) ) {
				  case 'c': switch ( stemmed ) {
							case "achiev": return "achieve";
						    }
							break;
				  case 'd': switch ( stemmed ) {
							case "advanc"   : return "advance";
							case "adjudicat": return "adjudicate";
						    }
							break;
				  case 'f': switch ( stemmed ) {
							case "aft": return "after";
						    }
							break;
				  case 'm': switch ( stemmed ) {
							case "amb" : return "amber";
							case "amaz": return "amaze";
						    }
							break;
				  case 'n': switch ( stemmed ) {
							case "analyz" :
							...
							break;
				  case 's': switch ( stemmed ) {
							case "associat": return "associate";
						    }
							break;
				  case 't': switch ( stemmed ) {
							case "attribut": return "attribute";
						    }
							break;
				  }
				  break;
		case 'b': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
							case "bas" : return "base";
							case "bak" : return "bake";
							case "basi": return "basis";
						    }
							break;
				  case 'e': switch ( stemmed ) {
							case "bel"  : return "belly";
							case "bet"  : if ( ending == ER ) return "better";
							case "becom": return "become";
						    }
							break;
				  case 'i': switch ( stemmed ) {
							case "bia": return "bias";
						    }
							break;
				  case 'o': switch ( stemmed ) {
							case "bor": return "boring";
						    }
							break;
				  case 'r': switch ( stemmed ) {
							case "broth": if ( ending == ER ) return "brother";
						    }
							break;
				  }
				  break;
		case 'c': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'e': switch ( stemmed ) {
							...
							case "cent"  : if ( ending == ER )return "center";
						    }
							break;
				  case 'h': switch ( stemmed ) {
				  ...
				  case 'l': switch ( stemmed ) {
							...
							break;
				  case 'o': switch ( stemmed ) {
							case "comput" : if ( ending == ER ) return "computer"; else return "compute";
				  ...
				  break;
		case 'd': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  break;
		case 'e': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'x': switch ( stemmed ) {
							...
							break;
				  case 'v': switch ( stemmed ) {
							case "even"  : if ( ending == ING ) return "evening";
						    }
							break;
				  }
				  break;
		case 'f': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  break;
		case 'g': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  break;
		case 'h': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'i': switch ( stemmed ) {
							...
							case "hilt": if ( ending == ER ) return "hitler";
						    }
							break;
				  }
				  break;
		case 'i': switch ( stemmed.charAt( 1 ) ) {
				  case 's': switch ( stemmed ) {
				  ...
				  case 'n': switch ( stemmed ) {
							...
							case "inc"      : if ( ending == EST ) return "incest";
		...
		case 'j': break;
		case 'k': break;
		case 'l': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'o': switch ( stemmed ) {
							...
							break;
				  case 'u': switch ( stemmed ) {
							case "lucif": return "lucifer";
						    }
							break;
				  }
				  break;
		case 'm': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
							case "manag"  : return "manage";
							case "maximiz": return "maximize";
							case "mat"    : if ( ending == ER ) return "matter";
				  ...
				  case 'o': switch ( stemmed ) {
							...
							case "moth" : if ( ending == ER ) return "mother";
							case "movy" : return "movie";
							case "morn" : if ( ending == ING ) return "morning";
							case "motivat": return "motivate";
						    }
							break;
				  }
				  break;
		case 'n': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  break;
		case 'o': switch ( stemmed.charAt( 1 ) ) {
				  case 'b': switch ( stemmed ) {
							...
							break;
				  case 'f': switch ( stemmed ) {
							case "offic" : if ( ending == ER ) return "officer"; else return "office";
							case "officy": return "office";
						    }
							break;
				  case 'p': switch ( stemmed ) {
				  ...
				  break;
		case 'p': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'o': switch ( stemmed ) {
							...
							case "pow" : if ( ending == ER ) return "power";
							case "pok" : if ( ending == ER ) return "poker"; else return "poke";
						    }
							break;
				  case 'r': switch ( stemmed ) {
				  ...
				  break;
		case 'q': break;
		case 'r': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'e': switch ( stemmed ) {
							...
							break;
				  case 'i': switch ( stemmed ) {
							case "rid": if ( ending == ES || ending == ING ) return "ride";
							case "riv": return "river";
							case "ris": if ( ending == ER )return "riser"; else return "rise";
						    }
							break;
				  case 'o': switch ( stemmed ) {
				  ...
				  break;
		case 's': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'i': switch ( stemmed ) {
							...
							case "sid" : if ( ending == ES || ending == ING ) return "side";
				  ...
				  break;
		case 't': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
							...
							break;
				  case 'e': switch ( stemmed ) {
							case "tear"  : if ( ending == S ) return "tears";
				  ...
				  case 'r': switch ( stemmed ) {
							...
							break;
				  case 'w': switch ( stemmed ) {
							case "twit": return "twitter";
						    }
							break;
				  }
				  break;
		case 'u': switch ( stemmed.charAt( 1 ) ) {
				  case 'n': switch ( stemmed ) {
							case "unit"		: if ( ending == ED ) return "united";
				  ...
				  break;
		case 'v': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  break;
		case 'w': switch ( stemmed.charAt( 1 ) ) {
				  case 'a': switch ( stemmed ) {
				  ...
				  case 'r': switch ( stemmed ) {
							...
							break;
				  case 'o': switch ( stemmed ) {
							case "work": if ( ending == ER ) return "worker";
							case "wo"  : return "woes";
						    }
							break;
				  }
